...
class DepartementsController extends Controller
{
    ...
    /*public function listEtudiants(){
        $riewRow= DB::select('SELECT nom,prenom,cne,phone,email FROM etudiants') 
        
       
        return view('Departement/Etudiants/list');
    }*/
    public function listeEtud(){
    ...
    public function listeEncadrant(){
        $riewRow = DB::select('SELECT * FROM encadrants');
        return view('Departement/Etudiants/list',['viewReport'=> $riewRow]);
    }
